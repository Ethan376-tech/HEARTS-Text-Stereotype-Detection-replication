...
def train_model(train_data, model_output_base_dir, dataset_name, feature_type, seed):
    ...
    if feature_type == 'tfidf':
        ...
        # Use batch processing for much faster embedding computation
        ...
        for i in tqdm(range(0, len(texts), batch_size), desc="Computing embeddings"):
            ...
            docs = list(nlp.pipe(batch, batch_size=batch_size, disable=["parser", "ner"]))
            embeddings.extend([doc.vector for doc in docs])
